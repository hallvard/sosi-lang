...
- [src/sosi.langium](src/sosi.langium) -  The grammar definition of your language
- [src/sosi-module.ts](src/sosi-module.ts) - The dependency injection module of your language implementation. Use this to register overridden and added services.
- [src/sosi-validator.ts](src/sosi-validator.ts) - An example validator. You should change it to reflect the semantics of your language.
...
- [src/syntaxes/sosi.monarch.ts](src/syntaxes/sosi.monarch.ts) - Monarch based syntax highlighting instructions.
- [syntaxes/sosi.tmLanguage.json](syntaxes/sosi.tmLanguage.json) - Textmate based syntax highlighting instructions.
